          ...
          <tr>
            <td height="530" align="center" valign="top"><table width="100%" border="0">
              ...
              <tr>
                ...
                <tr>
                  <td height="33" align="center" valign="middle" style="font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-weight: bold; font-size: large;">Student Details Edit</td>
                </tr>
                <tr>
                   <%!
                	   ...
                	   try
                	    {
                		    ...
                		    if(!ErrorFlag)
                		    {
                		    	 result= StudentBL.updateStudent(student);
                 			    if(result>0)
                 			    {
                  ...
                  else
                   {
                	   ...
                	   if(student!=null)
                	   {
                		   ...
                		   sMark1=""+student.getMark1();
                		   sMark2=""+student.getMark2();
                		   sMark3=""+student.getMark3();
                		   sStudent_id=""+student_id;
					      ...
					      <tbody>
					        <tr>
					          ...
					          <td width="16%" align="left" valign="middle">
					            <input type="text" name="txtStudentID" id="txtStudentID" value='<%=sStudent_id%>' readonly="true"></td>
					          <td width="26%" align="left" valign="middle" style="color: #F70509" ><%=eStudent_id%>
					          <span id="eStudent_id" style="color:red; visibility:hidden">id should be an positive integer</span>
					          </td>
					          <td width="2%">&nbsp;</td>
					          <td width="2%">&nbsp;</td>
					          </tr>
					        ...
					        <tr>
					          ...
					          <td align="left" valign="middle" style="color: #F70509"><%=eMark1%>
					             <span id="eMark1" style="color:red; visibility:hidden">enter valid mark(1-100)</span>
					          </td>
					          <td>&nbsp;</td>
					          <td>&nbsp;</td>
					          </tr>
					        <tr>
					          ...
					          <td align="left" valign="middle" style="color: #F70509"><%=eMark2%>
					            <span id="eMark2" style="color:red; visibility:hidden">enter valid mark(1-100)</span>
					          </td>
					          <td>&nbsp;</td>
					          <td>&nbsp;</td>
					          </tr>
					        <tr>
					          ...
					          <td align="left" valign="middle" style="color: #F70509"><%=eMark3%>
					            <span id="eMark3" style="color:red; visibility:hidden">enter valid mark(1-100)</span>
					          </td>
					          <td>&nbsp;</td>
					          <td>&nbsp;</td>
					          </tr>
